...
INSERT INTO "new_Company" ("config", "createdAt", "displayName", "id", "ownerEmail", "searchStrategy", "shortDescription", "slug", "tavusKBWeight", "tavusPersonaId", "tavusReplicaId", "updatedAt", "useTavusKB", "useTavusVideo", "websiteUrl") SELECT "config", "createdAt", "displayName", "id", "ownerEmail", "searchStrategy", "shortDescription", "slug", "tavusKBWeight", "tavusPersonaId", "tavusReplicaId", "updatedAt", "useTavusKB", "useTavusVideo", "websiteUrl" FROM "Company";
DROP TABLE "Company";
